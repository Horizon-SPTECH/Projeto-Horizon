...
Serviço de coleta e análise de dados de furtos no Espírito Santo, visando identificar padrões e otimizar a alocação de recursos policiais para aumentar a segurança nas áreas vulneráveis.
